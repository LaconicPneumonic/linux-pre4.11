...
func rename(oldname, newname string) error {
	if err := checkLinkOp(renameOp, oldname, newname); err != nil {
		return err
	}
...
func OpenFile(name string, flag int, perm FileMode) (*File, error) {
	if err := checkOpenFile(name, flag, perm); err != nil {
		return nil, err
	}
	chmod := false
...
func Remove(name string) error {
	if err := checkRemove(name); err != nil {
		return err
	}
...
func Link(oldname, newname string) error {
	if err := checkLinkOp(linkOp, oldname, newname); err != nil {
		return err
	}
...
func Symlink(oldname, newname string) error {
	if err := checkLinkOp(symlinkOp, oldname, newname); err != nil {
		return err
	}
